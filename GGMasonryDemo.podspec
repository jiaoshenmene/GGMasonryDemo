Pod::Spec.new do |s|  
  s.name             = "GGMasonryDemo"  
  s.version          = "0.0.1"  
  s.summary          = "A marquee view used on iOS."  
  #s.description      = <<-DESC  
   #                    It is a marquee view used on iOS, which implement by Objective-C.  
    #                   DESC  
  s.homepage         = "https://github.com/jiaoshenmene/GGMasonryDemo"  
  # s.screenshots      = "www.example.com/screenshots_1", "www.example.com/screenshots_2"  
  s.license          = 'MIT'  
  s.author           = { "杜甲" => "815319775@qq.com" }  
  s.source           = { :git => "https://github.com/jiaoshenmene/GGMasonryDemo.git", :tag => s.version.to_s }  
  ...
  s.source_files = 'GGMasonry_a/**/*.{h,m}'  
  # s.resources = 'Assets'  
